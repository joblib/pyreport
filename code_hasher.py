...
class CodeLine(object):
    ...
    def append(self, token):
        ...
        # FIXME: How do you deal with "#pyreport" now ?!
        #           Maybe the same way you deal with literal comments ?
...
class CodeBlock(object):
    ...
    def __repr__(self):
        return('<CodeBlock object, id %i, line %i, %s>'
...
class CodeHasher(object):
    ...
    def yieldcodeblocks(self):
        ...
        for codeline in self.yieldcodelines():            
            if codeline.is_new_block() and not last_line_has_decorator :
                if codeblock.string:
                    yield codeblock
